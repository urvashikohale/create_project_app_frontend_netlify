...
const ProjectList = () => {
  ...
  const loadAllProjects = () => {
    axios
      .get(
        "https://backend-createprojectapp-22f4635628b6.herokuapp.com/projects"
      )
      .then((data) => {
        setList(data.data);
      })
          ...
          return (
            <div key={project._id}>
              <div className="projectCard">
                <div>
                  <img
                    src={`https://backend-createprojectapp-22f4635628b6.herokuapp.com/project/image/${project._id} `}
                    alt="Project"
                    className="listImage"
                  />
                </div>
